    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='reviewmodel_user_id', to='common.usermodel', verbose_name='작성자 아이디')),
            ],
            options={
                'db_table': 'review',
            },
